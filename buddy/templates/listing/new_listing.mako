...
sortSelectOptions('#lga_id', true);
    ...
    var hasvalue = $('#step1 .state_id option:selected').val();
    if (hasvalue){
    $data = {id:hasvalue};
	getsubcategory($data);
        }
    category_id.on('change',function () {
        var selected = $( "#category_id option:selected" ).text();
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Post a property</li>
      </ol>
    </section>
                ...
                <div class="box-body">
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                ${form.select('category_id', options=h.get_pcategories(),prompt="Please select",class_="form-control required")}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    ${form.select('lga_id', options=[],class_="form-control required lga_id")}
                            ...
                            <div class="col-md-4">
                                ...
                                ${form.text('area', class_="form-control required", maxlength=20)}
                                </div>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name='body' id="body" rows="9" class="ckeditor form-control required" style="white-space:pre;"></textarea>
                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <button type="cancel" name="cancel" class="btn btn-flat bg-black">Cancel</button>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group">

                                    <button type="submit" name="submit" class="btn bg-purple btn-flat pull-right next-step" >Save & Add pictures</button>
                                </div>
                            </div>
                        </div>
                    </fieldset>
