...
${parent.header_tags()}
<link href="${request.static_url('buddy:static/uikit-2.20.3/css/components/slidenav.almost-flat.min.css')}" rel="stylesheet">
</%block>
<div class="container">
    <div class="row">
        <div class="col-sm-12">
...
<a href="#picModal" data-uk-modal="{center:true}" style="border-radius:0" class="btn btn-danger uk-margin-bottom">Add Pictures of this city</a>
<%include file="pictures.mako"/>
...
<!--#region Arrow Navigator Skin Begin -->
  ...
  <figcaption class="uk-overlay-panel uk-overlay-top uk-overlay-background"><h4>${len(locality.pictures)}. <small>Click Image to view larger and nicer</small></h4></figcaption>
                  </figure>
...
%else:
    <div class="text-center">
             <figure class="uk-overlay">
                           ...
                           <img  src="${request.static_url('buddy:static/nopics.jpg')}" width="300" alt="">
...
<%block name="script_tags">
    ...
    <script type="text/javascript" src="${request.static_url('buddy:static/jssor/js/jssor.js')}"></script>
        <script type="text/javascript" src="${request.static_url('buddy:static/jssor/js/jssor.slider.js')}"></script>
