...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="${request.route_url('account')}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
          ...
          <li class="active"><a href="#"><i class="fa fa-dashboard"></i>Add LGAs</a></li>
      </ol>
    </section>
<section class="content">
    <div class="box box-default">
        <div class="box-header">
            <h3 class="box-title">Add LGAs to ${state.name}</h3>
        </div>
        <div class="box-body">
...
<div class="form-group">
	${form.label("Name")}
		...
		<p class="help-block">Please enter a comma separated list of LGAs to add e.g Onitsha North etc.</p>
