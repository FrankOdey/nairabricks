...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		${form.textarea('body' ,rows="8", id="editor", class_="form-control")}
...
${form.label("Categorize Your Question")}<span class="req">*</span>
    ${form.select('category_id',options=sorted(categories,key=lambda x:x[1]),multiple="True", class_='form-control required')}
